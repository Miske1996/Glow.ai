...
final class SignInWithAppleToFirebase: UIViewControllerRepresentable {
    ...
    init(_ onLoginEvent: ((SignInWithAppleToFirebaseResponse) -> ())? = nil,sessionService:SessionService) {
    ...
    private func performSignIn(using requests: [ASAuthorizationRequest]) {
        ...
        appleSignInDelegates = SignInWithAppleDelegates(window: nil, currentNonce: currentNonce, onLoginEvent: self.onLoginEvent,session:self.sessionService)
...
class SignInWithAppleDelegates: NSObject {
    ...
    init(window: UIWindow?, currentNonce: String, onLoginEvent: ((SignInWithAppleToFirebaseResponse) -> ())? = nil,session:SessionService) {
        self.window = window
